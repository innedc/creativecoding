...
Via Illustrator hebben we een extra plank toegevoegd binnen in de doos waar we onze Raspberry PI op kunnen plaatsen. Onder de plank is er plaats voorzien om een laptop in te zetten met een gat aan de zijkant voor de kabels van de beamer.
...
Op de plank in het midden is er ook een gat voorzien om de draden van de Raspberry PI door te steken. _(zie foto rechts)_
